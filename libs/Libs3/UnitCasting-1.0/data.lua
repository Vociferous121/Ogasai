local L = AceLibrary("AceLocale-2.2"):new("UnitCasting")
local BS = AceLibrary("Babble-Spell-2.3")
local uc  = LibStub:GetLibrary("UnitCasting-1.0")
    ...
    uc.RegisterTable("SpellcastsToTrack", {
	   ...
	   [BS['Void Bolt']]				= {[[Interface\Icons\Spell_Shadow_ShadowBolt]],1.5},
	   [L['Ink Spray']]					= {[[Interface\Icons\Spell_Nature_Sleep]],1},
            -- AHN'QIRAJ
   ...
   --    [BS["Corruption"]]				 = {[[Interface\Icons\Spell_Shadow_AbominationExplosion]], 2}, instacat 90% for PVP - u can uncomment it if u need
    ...
    uc.RegisterTable("DebuffsToTrack", {
            -- BLACKWING LAIR
