...
function hotspotDB:setup()
	...
	-- Human 1-25
	hotspotDB:addHotspot('North Shire 1 - 2', 'Alliance', 1, 2, -8903.322, -69.84078, 86.58018);
	hotspotDB:addHotspot('North Shire 3 - 4', 'Alliance', 3, 4, -8724.425, -137.0334, 86.89613);
	hotspotDB:addHotspot('North Shire 5 - 6', 'Alliance', 5, 6, -9005.23, -316.80, 74.46);
	hotspotDB:addHotspot('Elvynn Forest 7 - 9', 'Alliance', 7, 9, -9202.76, 62.19, 77.55);
	...
	hotspotDB:addHotspot("Teldrassil 9-10", 'Alliance', 9, 10, 9411.51, 1121.82, 1249.81); 
	hotspotDB:addHotspot("Teldrassil 11-12", 'Alliance', 11, 12, 9428.69, 1693.50, 1304.38);
	...
	hotspotDB:addHotspot("Ashenvale 22-24", 'Alliance', 22, 24, 2647.01, 168.43, 92.14);
	...
	hotspotDB:addHotspot("Wetlands 25 - 28", ALL, 25, 28, -3462.16, -1414.47, 9.38);
	hotspotDB:addHotspot("Ashenvale 23", 'Alliance', 22, 27, 2873.68, -910.45, 197.96);
	hotspotDB:addHotspot("Ashenvale 25", 'Alliance', 24, 28, 2046.75, -1739.65, 75.40);
	hotspotDB:addHotspot("Ashenvale 25-30", 'Alliance', 25, 30, 3113.14, -1511.09, 195.10);
	hotspotDB:addHotspot("The Green Belt 27 - 29", 'Alliance', 27, 29, -3359.79, -3230.03, 22.16);
	hotspotDB:addHotspot("The Green Belt 27 - 29", 'Alliance', 27, 29, -3274.03, -3109.39, 21.82);
	hotspotDB:addHotspot("Direforge Hill 28 - 30", 'Alliance', 28, 30, -3192.38, -3017.26, 22.88);
	hotspotDB:addHotspot("Angerfang Encampment 28 - 30", 'Alliance', 28, 30, -3523.15, -2486.76, 50.68);
	hotspotDB:addHotspot("Angerfang Encampment 28 - 30", 'Alliance', 28, 30, -3478.35, -2414.66, 52.79);
	hotspotDB:addHotspot("Warsong Lumber Camp 27 - 30", 'Horde', 28, 30, 2563.96, -3283.46, 130.11);
	hotspotDB:addHotspot("Warsong Lumber Camp 28 - 30", 'Horde', 28, 30, 2307.86, -3347.48, 100.37);
	hotspotDB:addHotspot("Southfury River 27 - 30", 'Alliance', 28, 30, 2193.73, -3535.26, 45.96);
