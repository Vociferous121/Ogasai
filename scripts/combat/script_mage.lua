...
function script_mage:menu()
	...
	if (self.fireMage) then
		if (CollapsingHeader("Fire Mage Combat Options")) then
			Text("TODO!");
		end
	end
	
	if (self.arcaneMage) then
		if (CollapsingHeader("Arcane Mage Combat Options")) then
			Text("TODO!");
		end
	end
end